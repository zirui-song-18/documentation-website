...
| [`sparse_vector`]({{site.url}}{{site.baseurl}}/field-types/supported-field-types/sparse-vector/)               | Indexes a sparse vector for ANN search [`SEISMIC`]({{site.url}}{{site.baseurl}}/vector-search/ai-search/neural-sparse-seismic) |
