...
| [`sparse_vector`]({{site.url}}{{site.baseurl}}/field-types/supported-field-types/sparse-vector/)               | Indexes a vector for the approximate search algorithm [`SEISMIC`]({{site.url}}{{site.baseurl}}/vector-search/ai-search/neural-sparse-seismic) |
